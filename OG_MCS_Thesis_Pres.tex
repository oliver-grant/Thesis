...
\begin{tikzpicture}
  \only<2>{
  \draw (0,0) ellipse (1cm and 0.5cm) node[align=center] {$0.2$};
  \draw (3,-0.5) rectangle (0.5cm, 0.5cm) node[align=center] {$0.1$};
  \draw (4,0) ellipse (2cm and 0.5cm) node[align=center] {$0.4$};
}
\end{tikzpicture}
\end{figure}
