...
\cline{1-2}
 ...
 \cline{1-2}
 $(-\infty, {\color{blue}BE})$ & {\color{ForestGreen}$0.15$} & $\leftarrow$ {\color{ForestGreen} $ q_0$}\\ \cline{1-2}
 {\color{blue}$BE$} & {\color{BloodRed}$0.10$} & $\leftarrow$ {\color{BloodRed} $ p_1$}\\ \cline{1-2}
 $({\color{blue}BE}, {\color{blue}THE})$ & {\color{ForestGreen}$0.15$} & $\leftarrow$ {\color{ForestGreen} $ q_1$}\\ \cline{1-2}
 {\color{blue}$THE$} & {\color{BloodRed}$0.10$} & $\leftarrow$ {\color{BloodRed} $ p_2$}\\ \cline{1-2}
 $({\color{blue}THE}, {\color{blue}TO})$& {\color{ForestGreen}$0.01$} & $\leftarrow$ {\color{ForestGreen} $ q_2$}\\ \cline{1-2}
 {\color{blue}$TO$} & {\color{BloodRed}$0.10$} & $\leftarrow$ {\color{BloodRed} $ p_3$}\\ \cline{1-2}
...
\node [arn_n] {0.15 THE}
    child{ node [arn_n] {0.10  {\color{blue}$BE$}} 
