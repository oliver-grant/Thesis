...
\begin{claim}
$H(\frac{1}{2}-\frac{1}{2} \frac{q_m}{p_t}, \frac{1}{2} + \frac{1}{2} \frac{q_m}{p_t}) \geq 1- \frac{4}{5} (\frac{q_m}{p_t})^2$ when $\frac{q_m}{p_t} < \frac{1}{2}$
\end{claim}

\begin{proof}
In order to prove the claim, we find the minimum of \\
$H(\frac{1}{2}-\frac{1}{2} \frac{q_m}{p_t}, \frac{1}{2} + \frac{1}{2} \frac{q_m}{p_t}) - (1 - \frac{4}{5} (\frac{q_m}{p_t})^2)$ when $0 < \frac{q_m}{p_t} < \frac{1}{2}$. \\
To do this we take the derivative with respect to $\frac{q_m}{p_t}$. \\
Let $F= H(\frac{1}{2}-\frac{1}{2} \frac{q_m}{p_t}, \frac{1}{2} + \frac{1}{2} \frac{q_m}{p_t}) - (1 - \frac{4}{5} (\frac{q_m}{p_t})^2)$ \\
$\implies F = - (\frac{1}{2}-\frac{1}{2} \frac{q_m}{p_t})* lg(\frac{1}{2}-\frac{1}{2} \frac{q_m}{p_t}) - (\frac{1}{2} + \frac{1}{2} \frac{q_m}{p_t})*lg(\frac{1}{2} + \frac{1}{2} \frac{q_m}{p_t}) - (1 - \frac{4}{5} (\frac{q_m}{p_t})^2)$ \\
$\implies F' = lg(\frac{1}{2}-\frac{1}{2} \frac{q_m}{p_t}) - lg(\frac{1}{2} + \frac{1}{2} \frac{q_m}{p_t}) + \frac{8}{5}\frac{q_m}{p_t}$ \\ 
The only root here occurs when $\frac{q_m}{p_t} = 0$. Thus, we check when $\frac{q_m}{p_t} \rightarrow 0$ and $\frac{q_m}{p_t} \rightarrow \frac{1}{2}$. We note that: \\
$F \rightarrow 0^{+}$ when $\frac{q_m}{p_t} \rightarrow 0$ and \\
$F \rightarrow 0.0112781 > 0$ when $\frac{q_m}{p_t} \rightarrow \frac{1}{2}$. \\
