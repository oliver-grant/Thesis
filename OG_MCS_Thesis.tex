...
Despite providing an improved bound, it remains open as to whether or not this bound is tight. An example with expected cost strictly worse than $H+2$ has yet to be found.
