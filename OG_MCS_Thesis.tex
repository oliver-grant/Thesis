...
\node [circle,draw] (z){$\frac{3}{10}$}
  child {node [circle,draw] (a) {$\frac{2}{10}$}    
  }  
  child {node [circle,draw] (b) {$0$}
	  child {node [circle,draw] (e) {$0$}}
	  child {node [circle,draw] (f) {$\frac{5}{10}$}}
  };
...
\node [circle,draw] (z){$0$}
  child {node [circle,draw] (a) {$\frac{3}{10}$} 
  	child {node [circle,draw] (e) {$\frac{2}{10}$}}
	  child {node [circle,draw] (f) {$0$}}   
  }  
  child {node [circle,draw] (b) {$\frac{5}{10}$}
  };
